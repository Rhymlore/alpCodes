...
export default function Project({ title, description, tags, imageUrl}: 
    ...
    return (
        ...
        >
        <section 
            className='bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 group-even:pl-8 hover:bg-gray-200 transition rounded-lg'>
            <div
